...
declare_id!("5Lqb4KZUw1CK4GyeuMcoCcWYdWJmGP12yGUNyLcyk1Na");
...
pub mod escrow {
    ...
    pub fn close_offer(context: Context<CloseOffer>) -> Result<()> {
        instructions::close_offer::return_tokens_to_maker(&context)?;
        instructions::close_offer::close_offer_and_vault(context)
    }
}
